...
from common_files.treat.lat_univzero import UniverseZero
...
class TREAT(BaseTREAT):
    ...
    def __init__(self, material_lib, nndc_xs=False):
        ...
        self.core = Core(self.elements)
        self.main_universe = UniverseZero(self.core, self.mats, 3, 3)
        ...
        core_HW = 3*c.latticePitch/2.0 # Only three elements in this model, will be more in later models
